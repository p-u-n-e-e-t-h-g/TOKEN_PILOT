...
const ImproveCodeCommand_js_1 = require("./ImproveCodeCommand.js");
const TokenPilotClient_js_1 = require("./TokenPilotClient.js");
function activate(context) {
    const command = new ImproveCodeCommand_js_1.ImproveCodeCommand(new TokenPilotClient_js_1.TokenPilotClient());
    const register = (commandId, preset) => {
